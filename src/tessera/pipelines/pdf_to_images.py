    ...
    for page_index in range(len(doc)):
        ...
        for image_index, img in enumerate(image_list):
            ...
            image_filename = os.path.join(
                output_folder,
                f"page_{page_index + 1:03d}_img_{page_index + 1:03d}.{image_ext}",
            )
...
def all_extracted_images(data_directory: str, pdf_files: list) -> list:
    """
    ...
    for pdf_file in pdf_files:
        images = extract_images(data_directory, pdf_file)
